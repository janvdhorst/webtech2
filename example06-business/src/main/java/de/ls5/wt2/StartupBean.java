...
public class StartupBean {
    ...
    public void startup() {
        ...
        if (firstNewsItem == null) {
            ...
            news3.setHeadline("Peter Griffin");
            news3.setContent("I have an idea so smart that my head would explode if I even began to know what I was talking about.");
            news3.setPublishedOn(new Date());
            ...
            news5.setContent("Love is like a fart. if you have to force it, it's probably crap.");
